...
useSeoMeta({
  title: 'Экскурсии — TravelSite',
  description: 'ТОП экскурсий Сочи 2026: Красная Поляна, Роза Хутор, Абхазия, гора Ахун, 33 водопада, Скайпарк, квадроциклы, джип-тур, Олимпийский парк.'
})
...
<template>
  <div>
    <UPageHero
      ...
      description="ТОП экскурсий Сочи 2026. Красная Поляна, Роза Хутор, Абхазия, гора Ахун, 33 водопада, Скайпарк, квадроциклы, джип-тур, Олимпийский парк с шоу фонтанов."
